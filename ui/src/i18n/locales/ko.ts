...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "지워진 WhatsApp 세션이 없습니다. 이미 없거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개의 스레드를 보관했습니다",
    deleteAllArchived: "보관된 항목 모두 삭제…",
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 해당 대화 기록을 삭제하시겠습니까?",
    ...
    cloudWorkerPlacementConflict: "클라우드 워커: {state} · 워크스페이스 충돌 1건",
    cloudWorkerPlacementConflicts: "클라우드 워커: {state} · 워크스페이스 충돌 {count}건",
    cloudWorkerDescendantConflict: "클라우드 워커 하위: 워크스페이스 충돌 1건",
    cloudWorkerDescendantConflicts: "클라우드 워커 하위: 워크스페이스 충돌 {count}건",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "처리 중…",
      profileHint:
        "JPEG, PNG 또는 WebP. 이미지는 중앙을 기준으로 잘리고 512px로 크기가 조정됩니다.",
      profileLoadFailed: "프로필을 불러올 수 없습니다.",
      profileSaveFailed: "프로필을 저장할 수 없습니다.",
      avatarInvalid: "올바른 JPEG, PNG 또는 WebP 이미지를 선택하세요.",
  ...
  configView: {
    ...
    syncedHint: "Gateway를 통해 여러 기기 간에 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
      hint: "Gateway에서 브라우저 푸시 알림을 받습니다.",
      nativeHint: "알림은 이 Mac의 OpenClaw 앱에서 기본적으로 표시됩니다.",
      ...
      nativeBlockedHint:
        "macOS에서 OpenClaw의 알림이 비활성화되어 있습니다. 시스템 설정 > 알림에서 허용하세요.",
    },
    appearance: {
      theme: "테마",
    ...
    sidebarPrefs: {
      title: "사이드바",
      hint: "세션이 실행 중일 때 표시할 항목을 선택하세요.",
  ...
  subtitles: {
    ...
    notifications: "게이트웨이에서 전송되는 브라우저 푸시 알림.",
    security: "Gateway 인증, 실행 정책, 도구 프로필 및 승인.",
    advanced: "나머지 모든 구성 섹션과 원본 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    sensitiveReply: "민감한 응답을 보냈습니다",
    send: "보내기",
    thinking: "OpenClaw가 생각 중입니다",
    earlier: "이전",
    requestFailed: "OpenClaw가 응답할 수 없습니다. 다시 시도하세요.",
    connectionChanged: "Gateway 연결이 변경되었습니다. 이 설정을 계속하려면 다시 시도하세요.",
    sessionRestarted:
      "{error} OpenClaw가 새 세션을 시작했습니다. 이전 메시지는 컨텍스트로 남아 있습니다.",
    ...
    nudge: {
      configReload: "구성 다시 로드가 중단되었습니다 — 무슨 일이 있었는지 물어보세요",
  ...
  mcpServers: {
    ...
    nameInvalid: "서버 이름에는 문자, 숫자, 점, 대시 또는 밑줄을 사용합니다.",
    targetInvalid: "HTTP 전송의 경우 URL을, stdio의 경우 올바른 명령줄을 입력하세요.",
    nameTaken: "“{name}” 이름의 MCP 서버가 이미 존재합니다.",
    ...
    configUnavailable: "구성을 사용할 수 없습니다. 새로 고침 후 다시 시도하세요.",
    connectRequired: "MCP 서버를 변경하려면 Gateway에 연결하세요.",
    adminRequired: "MCP 서버 변경에는 operator.admin 액세스 권한이 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  mcpPage: {
    connectorsLink: "Plugins 페이지에서 원클릭 커넥터를 확인하세요.",
    servers: "서버",
    oauth: "OAuth",
    filtered: "필터링됨",
  ...
  labsPage: {
    intro: "Labs에는 릴리스 간에 변경, 중단되거나 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    sectionDescription: "변경 사항은 즉시 저장되며 향후 에이전트 실행에 적용됩니다.",
    documentation: "문서",
    ...
    codeMode: {
      title: "Code Mode",
      description: "에이전트가 컴팩트한 샌드박스 JavaScript 워크플로에서 도구를 조합하도록 하세요.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 오케스트레이션하도록 하세요.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저를 위한 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS에서 채팅, 대화, 작업 승인, OpenClaw로 공유하기.",
      },
      android: {
        title: "Android",
        desc: "완전한 OpenClaw 노드로서의 Android 폰 — 채팅, 카메라, Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      description: "이 gateway에서의 프로필입니다.",
      ...
      openSettings: "{name}의 신원 설정 열기",
      avatarErrors: {
        invalid: "이미지를 처리할 수 없습니다.",
        sourceTooLarge: "10 MB 이하의 이미지를 선택하세요.",
        tooLarge: "처리된 아바타가 512 KB를 초과합니다.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    announcement: {
      ...
      granted: "위젯 접근이 허용되었습니다.",
      rejected: "위젯 접근이 거부되었습니다.",
    },
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동합니다. Alt를 누른 채 화살표 키를 눌러 옮기세요.",
      moveHandle: "{title} 이동",
      ...
      remove: "제거",
      needsApproval: "승인 필요",
      needsApprovalDetail: "이 위젯이 추가 접근을 요청했습니다.",
      ...
      appStaleDetail: "서버, 리소스 또는 원본 대화 기록을 더 이상 사용할 수 없습니다.",
      retry: "재시도",
      frameResolverMissing: "위젯 콘텐츠를 사용할 수 없습니다.",
      sandboxUnavailable: "위젯 샌드박스 호스트를 사용할 수 없습니다.",
      frameAuthorizationFailed: "반복된 새로 고침 시도 후에도 위젯 인증에 실패했습니다.",
      sandboxOriginRequired:
        "반복된 새로 고침 시도 후에도 위젯 인증에 실패했습니다. Gateway가 위젯 샌드박스 포트를 라우팅하지 않는 리버스 프록시 또는 터널 뒤에서 실행되는 경우, mcp.apps.sandboxOrigin을 샌드박스 리스너로 라우팅되는 전용 공개 오리진으로 설정하세요.",
      errorTitle: "이 위젯을 불러올 수 없습니다",
      errorDetail: "문제는 이 카드에만 국한됩니다.",
      actionErrorTitle: "위젯 변경에 실패했습니다",
  ...
  workboard: {
    ...
    detailAddNote: "메모 추가",
    dashboardTitle: "대시보드",
    dashboardEmpty: "아직 대시보드가 없습니다 — 작업 중인 에이전트가 위젯을 고정할 수 있습니다.",
    openSession: "세션 열기",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "분기 전환에는 운영자 관리자 액세스 권한이 필요합니다.",
    ...
    board: {
      ...
      dockLeft: "채팅 왼쪽 고정",
      dockRight: "채팅 오른쪽 고정",
      dockBottom: "채팅 아래쪽 고정",
      dockHidden: "채팅 숨기기",
      resizeDock: "채팅 독 크기 조정",
      reopenChat: "채팅 표시",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw가 로컬 버전을 유지하고 다른 클라우드 변경 사항을 적용했습니다. 스테이징된 결과를 확인하거나 충돌된 경로에 대해 클라우드 버전을 가져오세요.",
      morePaths: "경로 {count}개 더보기",
      stagedResult: "스테이징된 클라우드 결과",
      copyStagedResult: "스테이징된 결과 참조 복사",
      inspectCloud: "첫 번째 클라우드 버전 검사",
      takeCloud: "첫 번째 클라우드 버전 가져오기",
      copyInspectCommand: "클라우드 검사 명령 복사",
      copyTakeCommand: "take-cloud 명령 복사",
      commandHelp:
        "이 명령들은 Bash 또는 zsh(Windows에서는 Git Bash)에서 실행하세요. inspect가 경로가 존재하지 않는다고 하면 클라우드가 해당 경로를 삭제한 것입니다. 확인 후 로컬 경로를 수동으로 제거하세요. checkout이 파일/디렉터리 충돌을 보고하면 방해가 되는 로컬 경로를 옮기거나 제거한 뒤 다시 시도하세요. 스테이징된 참조가 없으면 이 알림은 오래된 것이므로 로컬 경로를 변경하지 마세요.",
      commandsUnavailable:
        "이 파일 이름에는 터미널 제어 문자가 포함되어 있어 OpenClaw가 복사 가능한 셸 명령을 만들지 않습니다. 스테이징된 참조를 직접 검사하고 경로를 주의하여 수동으로 입력하세요.",
      ...
      eventDescription:
        "이 경로에는 로컬 버전이 유지되었으며, 다른 클라우드 변경 사항은 적용되었습니다.",
    },
    compaction: {
      label: "압축된 기록",
    ...
    messages: {
      ...
      rewind: "되감기",
      rewindConfirm: "이 메시지 이전으로 되감으시겠습니까?",
      rewindToHere: "여기까지 되감기",
      rewindUnavailable: "에이전트가 작업하는 동안에는 되감기를 사용할 수 없습니다",
      forkUnavailable: "에이전트가 작업하는 동안에는 분기를 사용할 수 없습니다",
      showLess: "간략히 보기",
      showMore: "더 보기",
    ...
    composer: {
      ...
      holdToRecordSetting: "마이크 버튼을 눌러 받아쓰기",
      holdToRecordSettingDescription:
        "작성기의 마이크 버튼을 누른 채 말한 다음, 손을 떼면 전송하지 않고 텍스트를 삽입합니다.",
      dictationAudioUnsupported: "Gateway가 지원하지 않는 받아쓰기 오디오 형식을 반환했습니다.",
      ...
      dictationFinalizationTimedOut: "마지막 부분 필사가 완료되기 전에 받아쓰기가 중지되었습니다.",
      dictationProviderUnavailable: "받아쓰기에 사용할 필사 공급자가 구성되지 않았습니다.",
      dictationRecording: "녹음 중 {elapsed}",
      dictationReleaseToInsert: "손을 떼면 받아쓰기가 삽입됩니다",
