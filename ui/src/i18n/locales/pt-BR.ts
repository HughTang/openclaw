...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão do WhatsApp armazenada foi removida. Ela pode já estar ausente ou seu diretório de autenticação pode precisar de limpeza manual.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Workers na nuvem exigem o runtime OpenClaw; {runtime} está selecionado.",
  ...
  sessionsView: {
    ...
    sessionState: "Estado do tópico",
    viewArchived: "Ver arquivados",
    sessionArchived: "Tópico arquivado",
    sessionsArchived: "{count} tópicos arquivados",
    deleteAllArchived: "Excluir todos os arquivados…",
    deleteAllArchivedConfirm: "Excluir {count} conversas arquivadas e suas transcrições?",
    ...
    runFailedReason: "Falha na execução: {reason}",
    ...
    lastActive: "Ativa pela última vez {time}",
    surface: "Superfície",
    subject: "Assunto",
    room: "Sala",
    space: "Espaço",
    ...
    cloudWorkerDescendantConflict: "Filho do worker na nuvem: 1 conflito de workspace",
    cloudWorkerDescendantConflicts: "Filhos do worker na nuvem: {count} conflitos de workspace",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado entre seus dispositivos através do gateway.",
    notifications: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Mostre a atividade mais recente do assistente ou da ferramenta abaixo das sessões em execução.",
    },
    connection: {
      title: "Conexão",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    labs: "Recursos experimentais de agente e ferramentas.",
    ...
    security: "Autenticação do Gateway, política de execução, perfil de ferramentas e aprovações.",
    advanced: "Todas as demais seções de configuração, além do editor de arquivo bruto.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Configuração e manutenção do sistema.",
    exitSetup: "Sair da configuração",
    newAgent: "Novo agente",
    hatchDraft: "Acorde, meu amigo!",
    placeholder: "Envie uma mensagem ao OpenClaw…",
    ...
    history: {
      ...
      description: "O que mudou neste sistema, do mais recente ao mais antigo.",
      ...
      opaqueChange:
        "A formatação ou os comentários foram alterados sem mudanças visíveis no caminho de configuração.",
      sources: {
    ...
    nudge: {
      configReload: "O recarregamento da configuração parou — pergunte-me o que aconteceu",
      channelAuth: "A autenticação do {channel} está degradada — pergunte-me o que aconteceu",
      channelDisconnected: "O {channel} acabou de se desconectar — pergunte-me o que aconteceu",
  ...
  mcpServers: {
    ...
    nameInvalid: "Nomes de servidor usam letras, números, pontos, traços ou sublinhados.",
    targetInvalid:
    ...
    connectRequired: "Conecte-se ao gateway para alterar os servidores MCP.",
    adminRequired: "As alterações no servidor MCP exigem acesso operator.admin.",
    enable: "Ativar",
    disable: "Desativar",
  ...
  mcpPage: {
    connectorsLink: "Descubra conectores de um clique na página Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    ...
    saveFailed: "Não foi possível salvar a configuração do recurso.",
    codeMode: {
      title: "Modo Código",
      description:
        "Permita que os agentes combinem ferramentas em fluxos de trabalho compactos e isolados em JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Permita que o Modo Código orquestre grupos de subagentes em paralelo.",
  ...
  appsPage: {
    heroTitle: "Leve o OpenClaw para todo lugar",
    heroTagline:
      "Aplicativos complementares para seu celular, relógio, desktop e navegador — além de plugins para expandir o que seu agente pode fazer.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Converse, fale, aprove ações e compartilhe no OpenClaw a partir do iOS.",
      },
      android: {
        title: "Android",
        desc: "Seu telefone Android como um nó completo do OpenClaw — chat, câmera e Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O aplicativo complementar para Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Aplicativo complementar na barra de menus do seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Aplicativo nativo para desktop — builds .deb e AppImage.",
      },
      chrome: {
        title: "Extensão do Chrome",
        desc: "Deixe o OpenClaw controlar seu Chrome atual — abas, páginas e formulários.",
      },
      plugins: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Acompanhamento automático",
    file: "Arquivo: {file}",
    truncated: "Saída de log truncada; mostrando o bloco mais recente.",
  ...
  board: {
    ...
    actionFailed: "A alteração do painel não pôde ser salva.",
    ...
    widget: {
      cellLabel:
        "Widget do painel: {title}. Use as setas para navegar. Mantenha Alt pressionado e pressione uma seta para movê-lo.",
      ...
      activeCapabilities: "Capacidades ativas do widget",
      ...
      retry: "Tentar novamente",
      frameResolverMissing: "O conteúdo do widget está indisponível.",
      sandboxUnavailable: "O host de sandbox do widget está indisponível.",
      frameAuthorizationFailed:
        "A autorização do widget falhou após várias tentativas de atualização.",
      sandboxOriginRequired:
        "A autorização do widget falhou após várias tentativas de atualização. Se o gateway for executado atrás de um proxy reverso ou túnel que não roteia a porta de sandbox do widget, defina mcp.apps.sandboxOrigin como uma origem pública dedicada roteada para o listener do sandbox.",
      errorTitle: "Não foi possível carregar este widget",
      errorDetail: "O problema está contido neste cartão.",
      actionErrorTitle: "A alteração do widget falhou",
      actionErrorDetail: "O dashboard manteve o estado anterior do widget.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Ainda não há dashboard — o agente em atividade pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Redimensionar doca do chat",
      reopenChat: "Mostrar chat",
      workboardCard: "Cartão do workboard: {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Junção da visualização de quadro · {tabs} abas · {widgets} widgets",
    ...
    workspaceConflict: {
      ...
      stagedResult: "Resultado da nuvem preparado",
      ...
      commandHelp:
        "Execute estes comandos no Bash ou zsh (Git Bash no Windows). Se a inspeção informar que o caminho não existe, a nuvem o excluiu; verifique e remova o caminho local manualmente. Se o checkout relatar um conflito de arquivo/diretório, mova ou remova o caminho local que está bloqueando e tente novamente. Se a ref preparada estiver ausente, o aviso está desatualizado; não altere o caminho local.",
      commandsUnavailable:
        "Este nome de arquivo contém caracteres de controle de terminal, então o OpenClaw não criará um comando de shell copiável para ele. Inspecione a ref preparada diretamente e insira o caminho manualmente com cuidado.",
    ...
    messages: {
      ...
      rewindUnavailable: "O retrocesso não está disponível enquanto o agente está trabalhando",
      forkUnavailable: "O fork não está disponível enquanto o agente está trabalhando",
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição da thread",
    ...
    composer: {
      ...
      cameraPageInactive: "As câmeras ficam indisponíveis enquanto esta página está inativa.",
      ...
      microphoneAppliesNextSession:
        "As alterações são aplicadas quando você iniciar sua próxima sessão do Talk.",
      ...
      holdToRecordSetting: "Segure o botão do microfone para ditar",
      holdToRecordSettingDescription:
        "Segure o botão do microfone no compositor, fale e depois solte para inserir o texto sem enviar.",
      ...
      dictationFinalizing: "Concluindo ditado…",
      dictationFinalizationTimedOut:
        "O ditado foi interrompido antes que a última transcrição parcial pudesse ser finalizada.",
      dictationProviderUnavailable: "Nenhum provedor de transcrição está configurado para ditado.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Falha na exportação do widget. Tente novamente.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "É necessário acesso de gravação do operador para abrir esta discussão.",
