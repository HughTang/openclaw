...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Збережену сесію WhatsApp не очищено. Можливо, її вже немає, або каталог авторизації потребує ручного очищення.",
    },
  ...
  agentChip: {
    ...
    agents: "Агенти",
    openChat: "Чат із {name}",
    offlineOpenSettings: "Офлайн — відкрити Налаштування",
  ...
  sessionsView: {
    ...
    viewArchived: "Переглянути архівовані",
    sessionArchived: "Гілку архівовано",
    sessionsArchived: "Архівовано гілок: {count}",
    deleteAllArchived: "Видалити всі архівовані…",
    deleteAllArchivedConfirm: "Видалити {count} архівованих гілок та їх транскрипти?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarInvalid: "Виберіть дійсне зображення JPEG, PNG або WebP.",
      avatarTooLarge: "Оброблений аватар все ще завеликий.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw у macOS. Дозвольте їх у Системні параметри > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Показувати активність агента в бічній панелі в реальному часі",
      liveActivityHint:
        "Показувати останню активність асистента або інструмента під запущеними сеансами.",
    },
    connection: {
      title: "Підключення",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Інші очікувані запити",
    reviewRequest: "Перегляньте схвалення від {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Супутні застосунки для телефона, годинника, комп’ютера й браузера.",
    ...
    custodian: "Налаштування системи та обслуговування.",
    ...
    labs: "Експериментальні можливості агента й інструментів.",
    ...
    notifications: "Push-сповіщення браузера з вашого gateway.",
    security: "Автентифікація Gateway, політика виконання, профіль інструментів і схвалення.",
    advanced: "Усі решта розділів конфігурації, а також редактор необробленого файлу.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Налаштування системи та обслуговування.",
    exitSetup: "Вийти з налаштування",
    newAgent: "Новий агент",
    hatchDraft: "Прокидайся, друже!",
    placeholder: "Написати OpenClaw…",
    ...
    sessionRestarted:
      "{error} OpenClaw розпочав нову сесію; попередні повідомлення залишаються для контексту.",
    unsupportedGateway: "Оновіть Gateway, щоб продовжити налаштування з OpenClaw.",
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, спочатку найновіше.",
      loading: "Завантаження останніх змін…",
      empty: "Поки що немає записаних змін.",
    ...
    nudge: {
      ...
      channelAuth: "Автентифікацію {channel} погіршено — запитайте мене, що сталося",
      channelDisconnected: "{channel} щойно від'єднано — запитайте мене, що сталося",
      channelDegraded: "Роботу {channel} погіршено — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    nameInvalid: "Імена серверів можуть містити літери, цифри, крапки, дефіси або підкреслення.",
    targetInvalid: "Введіть URL для транспорту HTTP або дійсний командний рядок для stdio.",
    nameTaken: "Сервер MCP з назвою «{name}» вже існує.",
    missing: "Сервер MCP «{name}» не знайдено в конфігурації.",
    missingTransport: "відсутній транспорт",
    addedSuccess: "Додано сервер MCP {name}.",
    enabledSuccess: "Увімкнено сервер MCP {name}.",
    disabledSuccess: "Вимкнено сервер MCP {name}.",
    removedSuccess: "Видалено сервер MCP {name}.",
    configUnavailable: "Конфігурація недоступна; оновіть і спробуйте ще раз.",
    connectRequired: "Підключіться до Gateway, щоб змінити сервери MCP.",
    adminRequired: "Зміни серверів MCP потребують доступу operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  sessionsPage: {
    hubTablistLabel: "Розділи потоків",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    restartRequired: "Потрібен перезапуск Gateway.",
  ...
  appsPage: {
    heroTitle: "Візьміть OpenClaw усюди",
    heroTagline:
      "Супутні застосунки для телефона, годинника, комп'ютера та браузера — а також плагіни, які розширюють можливості вашого агента.",
    sectionMobile: "На вашому телефоні",
    havePhone: "Уже маєте застосунок?",
    pairDevice: "З'єднайте свій пристрій",
    sectionWatch: "На вашому зап'ясті",
    sectionDesktop: "На вашому комп'ютері",
    sectionBrowser: "У вашому браузері",
    sectionCommunity: "Спільнота",
    badgeBundledIos: "Входить до застосунку для iOS",
    badgeBundledAndroid: "Входить до застосунку для Android",
    ...
    ctaBrowseClawHub: "Переглянути ClawHub",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Ваш телефон Android як повноцінний вузол OpenClaw — чат, камера й Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкі перегляди чатів і миттєві відповіді з вашого зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Супутник для Android розширює OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
        desc: "Супутник у рядку меню для вашого Gateway — сповіщення, підтвердження, швидкий чат.",
      },
      windows: {
        title: "Windows",
        desc: "Супутник для Windows підключає ваш ПК як вузол OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "Розширюйте OpenClaw за допомогою каналів, інструментів і Skills від спільноти.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "Електронні адреси, пов'язані з цим профілем.",
      openSettings: "Відкрити налаштування ідентичності для {name}",
      avatarErrors: {
  ...
  gatewayLogs: {
    ...
    file: "Файл: {file}",
    truncated: "Вивід журналу скорочено; показано останню частину.",
  ...
  board: {
    label: "Панель потоків",
    tabsLabel: "Вкладки панелі",
    moreTabs: "Більше вкладок панелі",
    gridLabel: "Віджети панелі",
    emptyTitle: "Чиста дошка, готова до роботи",
    emptyHint: "Ваш агент може закріпити тут віджети — спробуйте попросити картку статусу.",
    actionFailed: "Не вдалося зберегти зміну панелі.",
    actionInProgress: "Ще зберігається інша зміна панелі.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Віджет панелі: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть клавішу зі стрілкою, щоб перемістити його.",
      ...
      rejectedDetail: "Цей віджет залишається неактивним, доки його не видалять або не замінять.",
      appLoading: "Відновлення застосунку…",
      appStaleTitle: "Цей закріплений застосунок застарів",
      appStaleDetail: "Його сервер, ресурс або вихідний транскрипт більше недоступні.",
      retry: "Повторити",
      ...
      sandboxOriginRequired:
        "Не вдалося авторизувати віджет після кількох спроб оновлення. Якщо Gateway працює за зворотним проксі або тунелем, який не маршрутизує порт пісочниці віджета, встановіть для mcp.apps.sandboxOrigin окреме публічне походження, що маршрутизується до слухача пісочниці.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Панелі ще немає — робочий агент може закріплювати віджети.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Для перемикання гілок потрібен адміністративний доступ оператора.",
    ...
    board: {
      ...
      defaultTab: "Головна",
      mockPlaceholder: "З’єднання перегляду дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
      mockResearch: "Дослідження",
      mockSessionStatus: "Статус потоку",
      mockRecentFindings: "Останні знахідки",
      mockSourceMap: "Карта джерел",
      resetTitle: "Скинути розмову?",
      resetDescription: "Контекст розмови скидається. Ваша панель залишається.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw зберіг ваші локальні версії та застосував інші хмарні зміни. Перегляньте підготовлений результат або візьміть його версію для конфліктного шляху.",
      ...
      commandHelp:
        "Виконайте це в Bash чи zsh (Git Bash у Windows). Якщо inspect повідомляє, що шлях не існує, хмара його видалила; перевірте та видаліть локальний шлях вручну. Якщо checkout повідомляє про конфлікт файлу/каталогу, перемістіть або видаліть локальний шлях, що блокує, а потім повторіть спробу. Якщо підготовленого ref немає, повідомлення застаріле; не змінюйте локальний шлях.",
      commandsUnavailable:
        "Ця назва файлу містить керуючі символи термінала, тож OpenClaw не створюватиме для неї копійовану команду оболонки. Огляньте підготовлений ref безпосередньо та обережно введіть шлях вручну.",
      dismiss: "Закрити повідомлення про конфлікт робочої області",
      eventSender: "Хмарна робоча область",
    ...
    messages: {
      activity: "Активність",
      forkFromHere: "Розгалузити звідси",
      hide: "Приховати",
      ...
      rewind: "Перемотати",
      rewindConfirm: "Перемотати до стану перед цим повідомленням?",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може відображати список камер.",
      ...
      microphoneAppliesNextSession: "Зміни застосуються, коли ви почнете наступний сеанс Talk.",
      microphoneListUnsupported: "Цей браузер не може показати список входів мікрофона.",
      noCameras: "Додаткових камер не знайдено",
      ...
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в редакторі, говоріть, а потім відпустіть, щоб вставити текст без надсилання.",
      dictationAudioUnsupported: "Gateway повернув непідтримуваний формат аудіо для диктування.",
      dictationBrowserAudioUnsupported:
        "Цей браузер не може захоплювати аудіо для диктування на частоті 8 кГц.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Цей віджет потрібно повторно відрендерити, щоб експортувати як зображення.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Для відкриття цього обговорення потрібен доступ оператора на запис.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Запускається щосекунди",
      ...
      summaryEverySeconds: "Запускається кожні {amount} секунд",
