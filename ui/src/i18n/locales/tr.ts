...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizininin elle temizlenmesi gerekebilir.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Uygulamanız henüz yok mu?",
  ...
  sessionsView: {
    ...
    global: "Genel",
    unknown: "Bilinmiyor",
    sessionState: "İş parçacığı durumu",
    viewArchived: "Arşivlenenleri görüntüle",
    sessionArchived: "İş parçacığı arşivlendi",
    sessionsArchived: "{count} iş parçacığı arşivlendi",
    ...
    dashboardAvailable: "Kontrol paneli kullanılabilir",
    ...
    cloudWorkerPlacementConflict: "Bulut çalışanı: {state} · 1 çalışma alanı çakışması",
    cloudWorkerPlacementConflicts: "Bulut çalışanı: {state} · {count} çalışma alanı çakışması",
    cloudWorkerDescendantConflict: "Bulut çalışanı alt öğesi: 1 çalışma alanı çakışması",
    cloudWorkerDescendantConflicts: "Bulut çalışanı alt öğeleri: {count} çalışma alanı çakışması",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler ortadan kırpılır ve 512px'e yeniden boyutlandırılır.",
  ...
  configView: {
    ...
    syncedHint: "Cihazlarınız arasında Gateway üzerinden senkronize edilir.",
    notifications: {
      ...
      nativeBlockedHint:
        "macOS'te OpenClaw için bildirimler devre dışı. Sistem Ayarları > Bildirimler bölümünden bunlara izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} tarafından onay incelemesi: {command}",
  ...
  subtitles: {
    ...
    apps: "Telefon, saat, masaüstü ve tarayıcı için tamamlayıcı uygulamalar.",
    ...
    labs: "Deneysel ajan ve araç yetenekleri.",
    ...
    security: "Gateway kimlik doğrulama, exec ilkesi, araç profili ve onaylar.",
    advanced: "Kalan tüm yapılandırma bölümleri ve ham dosya düzenleyici.",
  ...
  custodian: {
    ...
    connectionChanged: "Gateway bağlantısı değişti. Bu kuruluma devam etmek için tekrar deneyin.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Bu sistemde neyin değiştiği, en yeniden başlayarak.",
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yüklemesi durdu — bana ne olduğunu sor",
      channelAuth: "{channel} kimlik doğrulaması bozuldu — bana ne olduğunu sor",
      channelDisconnected: "{channel} az önce bağlantısı kesildi — bana ne olduğunu sor",
      channelDegraded: "{channel} bozuldu — bana ne olduğunu sor",
  ...
  mcpServers: {
    ...
    configUnavailable: "Yapılandırma kullanılamıyor; yenileyip yeniden deneyin.",
  ...
  mcpPage: {
    connectorsLink: "Plugins sayfasında tek tıkla bağlanan konektörleri keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    intro:
      "Labs, sürümler arasında değişebilecek, bozulabilecek veya kaybolabilecek deneysel özellikler içerir.",
    sectionTitle: "Deneysel özellikler",
    sectionDescription:
      "Değişiklikler anında kaydedilir ve gelecekteki aracı çalıştırmalarına uygulanır.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'tan OpenClaw ile sohbet edin, konuşun, eylemleri onaylayın ve paylaşın.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden bakışta sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android yardımcısı OpenClaw'ı saatinize genişletir.",
      },
      macos: {
        title: "macOS",
        desc: "Gateway'iniz için menü çubuğu yardımcısı — bildirimler, onaylar, hızlı sohbet.",
      },
      windows: {
        title: "Windows",
        desc: "Windows yardımcısı, bilgisayarınızı bir OpenClaw düğümü olarak bağlar.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "OpenClaw'un mevcut Chrome'unuzu yönetmesine izin verin — sekmeler, sayfalar ve formlar.",
      },
      plugins: {
        title: "Eklentiler ve ClawHub",
        desc: "OpenClaw'u topluluktan gelen kanallar, araçlar ve becerilerle genişletin.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG veya WebP. Görseller 256 × 256 veya daha küçük olacak şekilde yeniden boyutlandırılır.",
      ...
      avatarErrors: {
        ...
        tooLarge: "İşlenen avatar 512 KB'den büyük.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    gridLabel: "Pano widget'ları",
    emptyTitle: "Boş bir pano, çalışmaya hazır",
    emptyHint: "Ajanınız buraya widget'lar sabitleyebilir — bir durum kartı istemeyi deneyin.",
    actionFailed: "Kontrol paneli değişikliği kaydedilemedi.",
    actionInProgress: "Başka bir kontrol paneli değişikliği hâlâ kaydediliyor.",
    announcement: {
      moved: "{title} taşındı.",
      resized: "{title} yeniden boyutlandırıldı.",
      removed: "{title} kaldırıldı.",
      granted: "Widget erişimine izin verildi.",
      rejected: "Widget erişimi reddedildi.",
    },
    widget: {
      cellLabel:
        "Kontrol paneli widget'ı: {title}. Gezinmek için ok tuşlarını kullanın. Taşımak için Alt tuşunu basılı tutup bir ok tuşuna basın.",
      moveHandle: "{title} taşı",
      resizeHandle: "{title} yeniden boyutlandır",
      ...
      rejectedDetail: "Bu widget kaldırılana veya değiştirilene kadar etkin olmaz.",
      appLoading: "Uygulama geri yükleniyor…",
      appStaleTitle: "Bu sabitlenmiş uygulama güncelliğini yitirdi",
      ...
      sandboxUnavailable: "Widget kum havuzu ana bilgisayarı kullanılamıyor.",
      ...
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget kum havuzu bağlantı noktasını yönlendirmeyen bir ters proxy veya tünel arkasında çalışıyorsa, mcp.apps.sandboxOrigin değerini kum havuzu dinleyicisine yönlendirilen özel bir genel kaynağa ayarlayın.",
      errorTitle: "Bu widget yüklenemedi",
      errorDetail: "Sorun bu kartla sınırlıdır.",
      actionErrorTitle: "Widget değişikliği başarısız oldu",
      actionErrorDetail: "Panel önceki widget durumunu korudu.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Henüz panel yok — çalışan aracı widget'ları sabitleyebilir.",
    openSession: "Oturumu aç",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Ajan çalışırken dal değiştirme kullanılamaz.",
    ...
    board: {
      ...
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü dikiş · {tabs} sekme · {widgets} widget",
      ...
      resetDescription: "Konuşma bağlamı sıfırlanır. Panonuz kalır.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw yerel sürümlerinizi korudu ve diğer bulut değişikliklerini uyguladı. Hazırlanan sonucu inceleyin veya çakışan bir yol için onun sürümünü alın.",
      ...
      commandHelp:
        "Bunları Bash veya zsh'de çalıştırın (Windows'ta Git Bash). Eğer inspect yolun mevcut olmadığını söylüyorsa, bulut onu silmiştir; doğrulayın ve yerel yolu elle kaldırın. Eğer checkout bir dosya/dizin çakışması bildiriyorsa, engelleyen yerel yolu taşıyın veya kaldırın, ardından tekrar deneyin. Eğer hazırlanan ref eksikse, bildirim eskidir; yerel yolu değiştirmeyin.",
      commandsUnavailable:
        "Bu dosya adı terminal kontrol karakterleri içerdiğinden, OpenClaw bunun için kopyalanabilir bir kabuk komutu oluşturmaz. Hazırlanan ref'i doğrudan inceleyin ve yolu dikkatle elle girin.",
    ...
    messages: {
      ...
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı yine de görür.",
      ...
      rewind: "Geri sar",
      rewindConfirm: "Bu mesajdan önceye geri sarılsın mı?",
    ...
    modelControls: {
      ...
      usingDefault: "Ayarlardaki varsayılan kullanılıyor",
    ...
    composer: {
      ...
      dictationBrowserAudioUnsupported: "Bu tarayıcı 8 kHz'de dikte sesi yakalayamıyor.",
      dictationConnecting: "Dikte başlatılıyor…",
      dictationDisconnected: "Gateway bağlantısı kesildiğinden dikte durdu.",
      ...
      selectedCameraUnavailable:
        "Seçilen kamera kullanılamıyor. Başka bir kamera veya Sistem varsayılanını seçin.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Bu widget'ın görüntü olarak dışa aktarılması için yeniden oluşturulması gerekir.",
      widgetExportFailed: "Widget dışa aktarma başarısız oldu. Tekrar deneyin.",
    ...
    sessionDiscussion: {
      ...
      openExternal: "Tartışmayı yeni sekmede aç",
