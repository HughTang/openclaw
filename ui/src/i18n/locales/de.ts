...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Sie ist möglicherweise bereits nicht vorhanden, oder ihr Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud-Worker benötigen die OpenClaw-Runtime; {runtime} ist ausgewählt.",
  ...
  sessionsView: {
    ...
    invalidEmojiIcon: "Geben Sie genau ein Emoji ein.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarInvalid: "Wähle ein gültiges JPEG-, PNG- oder WebP-Bild.",
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf deinen Geräten synchronisiert.",
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Erlaube sie in Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Wähle, was während laufender Sitzungen angezeigt wird.",
      liveActivity: "Live-Agent-Aktivität in Seitenleiste anzeigen",
      liveActivityHint:
        "Zeige die neueste Assistenten- oder Tool-Aktivität unterhalb laufender Sitzungen.",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    security: "Gateway-Authentifizierung, Ausführungsrichtlinie, Tool-Profil und Freigaben.",
  ...
  custodian: {
    ...
    earlier: "Früher",
    requestFailed: "OpenClaw konnte nicht antworten. Bitte erneut versuchen.",
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Wiederhole den Vorgang, um diese Einrichtung fortzusetzen.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Was sich an diesem System geändert hat, neueste zuerst.",
      ...
      invalidEdit: "Diese manuelle Bearbeitung hat die Konfigurationsprüfung nicht bestanden.",
      opaqueChange:
        "Formatierung oder Kommentare wurden geändert, ohne sichtbare Änderungen an Konfigurationspfaden.",
      sources: {
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} wurde soeben getrennt — frag mich, was passiert ist",
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie One-Click-Konnektoren auf der Seite „Plugins“.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Änderungen werden sofort gespeichert und gelten für zukünftige Agent-Ausführungen.",
    documentation: "Dokumentation",
    restartRequired: "Neustart des Gateways erforderlich.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Agenten können Tools in kompakten, isolierten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Smartphone, Ihre Uhr, Ihren Desktop und Ihren Browser – plus Plugins, um die Fähigkeiten Ihres Agenten zu erweitern.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Dein Android-Telefon als vollwertiger OpenClaw-Knoten – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Die Android-Begleit-App erweitert OpenClaw auf deine Uhr.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Die Windows-Begleit-App verbindet deinen PC als OpenClaw-Knoten.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    emptyTitle: "Ein leeres Board, bereit zum Arbeiten",
    emptyHint: "Dein Agent kann hier Widgets anheften – bitte einfach um eine Statuskarte.",
    actionFailed: "Die Dashboard-Änderung konnte nicht gespeichert werden.",
    actionInProgress: "Eine weitere Dashboard-Änderung wird noch gespeichert.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Dashboard-Widget: {title}. Mit den Pfeiltasten navigieren. Alt gedrückt halten und eine Pfeiltaste drücken, um es zu verschieben.",
      ...
      sandboxUnavailable: "Der Sandbox-Host des Widgets ist nicht verfügbar.",
      ...
      sandboxOriginRequired:
        "Die Widget-Autorisierung ist nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn das Gateway hinter einem Reverse-Proxy oder Tunnel läuft, der den Widget-Sandbox-Port nicht weiterleitet, legen Sie mcp.apps.sandboxOrigin auf einen dedizierten öffentlichen Origin fest, der an den Sandbox-Listener weitergeleitet wird.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Kopiert",
      branches: "Thread-Verzweigungen",
      branchSwitchUnavailable:
        "Der Verzweigungswechsel ist nicht verfügbar, während der Agent arbeitet.",
      branchSwitchRequiresAdmin:
        "Für den Verzweigungswechsel ist Operator-Admin-Zugriff erforderlich.",
      untitledBranch: "Unbenannte Verzweigung",
      oneMessage: "{count} Nachricht",
      messages: "{count} Nachrichten",
      activeBranch: "Aktive Verzweigung",
    },
    board: {
      ...
      defaultTab: "Haupt",
      mockPlaceholder: "Board-Ansicht-Naht · {tabs} Tabs · {widgets} Widgets",
      mockOverview: "Übersicht",
      mockResearch: "Recherche",
      mockSessionStatus: "Thread-Status",
      mockRecentFindings: "Aktuelle Ergebnisse",
      mockSourceMap: "Quellenübersicht",
    ...
    workspaceConflict: {
      ...
      commandHelp:
        "Führe diese in Bash oder zsh aus (Git Bash unter Windows). Wenn inspect meldet, dass der Pfad nicht existiert, hat die Cloud ihn gelöscht; prüfe dies und entferne den lokalen Pfad manuell. Wenn checkout einen Datei-/Verzeichniskonflikt meldet, verschiebe oder entferne den blockierenden lokalen Pfad und versuche es erneut. Wenn die staged ref fehlt, ist der Hinweis veraltet; ändere den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, daher erstellt OpenClaw dafür keinen kopierbaren Shell-Befehl. Prüfe die staged ref direkt und gib den Pfad sorgfältig manuell ein.",
      dismiss: "Hinweis zum Workspace-Konflikt verwerfen",
      ...
      eventDescription:
        "Für diese Pfade wurden die lokalen Versionen beibehalten; andere Cloud-Änderungen wurden angewendet.",
    },
    compaction: {
    ...
    questions: {
      ...
      eyebrow: "Frage",
      cardLabel: "Frage des Assistenten",
      summaryLabel: "Ergebnis der Frage",
      timeRemaining: "Verbleibende Zeit",
      ownAnswer: "Deine eigene Antwort…",
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Auf den Stand vor dieser Nachricht zurückspulen?",
      rewindToHere: "Bis hierher zurückspulen",
      rewindUnavailable: "Zurückspulen ist nicht verfügbar, während der Agent arbeitet",
      forkUnavailable: "Verzweigen ist nicht verfügbar, während der Agent arbeitet",
    ...
    composer: {
      ...
      cameraAccessFailed: "Zugriff auf die Kamera nicht möglich.",
      ...
      microphoneAppliesNextSession:
        "Änderungen werden wirksam, wenn Sie Ihre nächste Talk-Sitzung starten.",
      ...
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste des Editors gedrückt, sprechen Sie und lassen Sie los, um Text einzufügen, ohne ihn zu senden.",
      ...
      dictationDisconnected: "Diktat wurde beendet, weil das Gateway getrennt wurde.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Diktat wurde beendet, bevor das letzte Teiltranskript abgeschlossen werden konnte.",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wählen Sie eine andere Kamera oder Systemstandard.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget-Export fehlgeschlagen. Versuchen Sie es erneut.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Zum Öffnen dieser Diskussion ist Operator-Schreibzugriff erforderlich.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Wird jede Sekunde ausgeführt",
      ...
      summaryEverySeconds: "Wird alle {amount} Sekunden ausgeführt",
