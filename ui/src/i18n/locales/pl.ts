...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie usunięto żadnej zapisanej sesji WhatsApp. Może już nie istnieć lub jej katalog uwierzytelniania może wymagać ręcznego wyczyszczenia.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Procesy robocze w chmurze wymagają środowiska uruchomieniowego OpenClaw; wybrano {runtime}.",
  ...
  sessionsView: {
    ...
    viewArchived: "Wyświetl zarchiwizowane",
    sessionArchived: "Zarchiwizowano wątek",
    ...
    dashboardAvailable: "Panel dostępny",
    approvalNeeded: "Wymagane zatwierdzenie",
    ...
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} konfliktów obszaru roboczego",
    cloudWorkerDescendantConflict: "Element podrzędny cloud worker: 1 konflikt obszaru roboczego",
    cloudWorkerDescendantConflicts:
      "Elementy podrzędne cloud worker: {count} konfliktów obszaru roboczego",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      saveProfile: "Zapisz nazwę",
      saving: "Zapisywanie…",
      uploading: "Przetwarzanie…",
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane do środka i skalowane do 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "Powiadomienia są wyświetlane natywnie przez aplikację OpenClaw na tym komputerze Mac.",
      ...
      nativeBlockedHint:
        "Powiadomienia dla OpenClaw są wyłączone w macOS. Zezwól na nie w Ustawieniach systemowych > Powiadomienia.",
    },
    appearance: {
      theme: "Motyw",
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co pojawia się podczas działających sesji.",
  ...
  execApproval: {
    ...
    reviewRequest: "Przejrzyj zatwierdzenie od {agent}: {command}",
  ...
  subtitles: {
    ...
    custodian: "Konfiguracja i obsługa systemu.",
    ...
    notifications: "Powiadomienia push w przeglądarce z Twojego gatewaya.",
    security: "Uwierzytelnianie Gateway, polityka wykonywania, profil narzędzi i zatwierdzenia.",
    advanced: "Wszystkie pozostałe sekcje konfiguracji oraz edytor surowego pliku.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Konfiguracja i obsługa systemu.",
    exitSetup: "Zakończ konfigurację",
    newAgent: "Nowy agent",
    hatchDraft: "Obudź się, przyjacielu!",
    placeholder: "Napisz do OpenClaw…",
    sensitivePlaceholder: "Wprowadź poufną wartość…",
    sensitiveReply: "Wysłano poufną odpowiedź",
    send: "Wyślij",
    thinking: "OpenClaw myśli",
    earlier: "Wcześniej",
    requestFailed: "OpenClaw nie mógł odpowiedzieć. Spróbuj ponownie.",
    connectionChanged:
      "Połączenie z Gateway uległo zmianie. Ponów, aby kontynuować tę konfigurację.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "Zmieniono formatowanie lub komentarze bez widocznych zmian ścieżek konfiguracji.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "ustawienia",
        cli: "CLI",
        pluginInstall: "instalacja wtyczki",
        manualEdit: "edycja ręczna",
        unknown: "nieznane",
      },
    },
    nudge: {
  ...
  mcpServers: {
    ...
    targetInvalid: "Wprowadź URL dla transportów HTTP lub prawidłowy wiersz polecenia dla stdio.",
    ...
    connectRequired: "Połącz się z bramą Gateway, aby zmienić serwery MCP.",
  ...
  mcpPage: {
    connectorsLink: "Odkryj łączniki jednym kliknięciem na stronie Plugins.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  labsPage: {
    intro:
      "Labs zawiera funkcje eksperymentalne, które mogą się zmieniać, przestać działać lub zniknąć między wydaniami.",
    ...
    saveFailed: "Nie udało się zapisać ustawienia funkcji.",
    codeMode: {
      title: "Code Mode",
      description:
    ...
    swarm: {
      title: "Swarm",
      description: "Pozwól Code Mode zarządzać grupami podagentów równolegle.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikacje towarzyszące na telefon, zegarek, komputer i przeglądarkę — oraz wtyczki rozszerzające możliwości Twojego agenta.",
    ...
    badgeBundledIos: "Dołączone do aplikacji na iOS",
    badgeBundledAndroid: "Dołączone do aplikacji na Androida",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Twój telefon z Androidem jako pełny węzeł OpenClaw — czat, aparat i Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Szybki podgląd czatów i błyskawiczne odpowiedzi prosto z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Aplikacja towarzysząca na Androida rozszerza OpenClaw na Twój zegarek.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Aplikacja towarzysząca dla Windows podłącza Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Natywna aplikacja na komputer — kompilacje .deb i AppImage.",
      },
      chrome: {
        title: "Rozszerzenie Chrome",
        desc: "Pozwól OpenClaw sterować Twoim istniejącym Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
        title: "Wtyczki i ClawHub",
        desc: "Rozszerz OpenClaw o kanały, narzędzia i umiejętności od społeczności.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      title: "Tożsamość",
      description: "Twój profil na tym gateway.",
      loading: "Ładowanie tożsamości…",
      profileUnavailable: "Nie można załadować profilu tożsamości.",
      notSet: "Tożsamość nie jest ustawiona.",
      setIdentity: "Ustaw tożsamość",
      avatar: "Awatar",
      avatarDescription:
        "PNG, JPEG lub WebP. Obrazy są zmniejszane do rozmiaru 256 × 256 lub mniejszego.",
      chooseAvatar: "Wybierz obraz",
      processingAvatar: "Przetwarzanie…",
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Widoczne dla innych osób korzystających z tego gateway.",
      linkedEmails: "Połączone adresy e-mail",
      linkedEmailsDescription: "Adresy e-mail połączone z tym profilem.",
      openSettings: "Otwórz ustawienia tożsamości dla {name}",
      avatarErrors: {
        invalid: "Nie można przetworzyć tego obrazu.",
  ...
  gatewayLogs: {
    title: "Logi",
    subtitle: "Logi plikowe Gateway (JSONL).",
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Wyjście logów skrócone; wyświetlanie najnowszego fragmentu.",
    empty: "Brak wpisów w logach.",
  },
  pluginTabs: {
  ...
  board: {
    ...
    actionInProgress: "Inna zmiana pulpitu jest nadal zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Dostęp do widżetu przyznany.",
      rejected: "Dostęp do widżetu odrzucony.",
    },
    widget: {
      cellLabel:
        "Widżet panelu: {title}. Użyj klawiszy strzałek do nawigacji. Przytrzymaj Alt i naciśnij strzałkę, aby go przesunąć.",
      ...
      appStaleDetail: "Jego serwer, zasób lub źródłowy transkrypt nie jest już dostępny.",
      retry: "Ponów",
      ...
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli gateway działa za reverse proxy lub tunelem, który nie przekierowuje portu piaskownicy widżetu, ustaw mcp.apps.sandboxOrigin na dedykowany publiczny origin przekierowany do nasłuchiwania piaskownicy.",
      errorTitle: "Nie udało się załadować tego widżetu",
      errorDetail: "Problem ogranicza się do tej karty.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Brak pulpitu — pracujący agent może przypinać widżety.",
    openSession: "Otwórz sesję",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Skopiowano",
      branches: "Gałęzie wątku",
      branchSwitchUnavailable: "Przełączanie gałęzi jest niedostępne, gdy agent pracuje.",
    ...
    board: {
      ...
      defaultTab: "Główna",
      mockPlaceholder: "Złącze widoku tablicy · {tabs} kart · {widgets} widżetów",
      ...
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Twój pulpit pozostanie bez zmian.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      titleMany: "Konflikty obszaru roboczego w chmurze: {count}",
      description:
        "OpenClaw zachował Twoje wersje lokalne i zastosował pozostałe zmiany z chmury. Sprawdź przygotowany wynik lub przejmij jego wersję dla ścieżki z konfliktem.",
      morePaths: "+{count} więcej ścieżek",
      stagedResult: "Przygotowany wynik z chmury",
      copyStagedResult: "Kopiuj odwołanie do przygotowanego wyniku",
      ...
      commandHelp:
        "Uruchom je w Bash lub zsh (Git Bash w systemie Windows). Jeśli inspekcja zgłasza, że ścieżka nie istnieje, chmura ją usunęła; zweryfikuj i usuń ścieżkę lokalną ręcznie. Jeśli checkout zgłosi konflikt pliku/katalogu, przenieś lub usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli brakuje przygotowanego odwołania, powiadomienie jest nieaktualne; nie zmieniaj ścieżki lokalnej.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera terminalowe znaki sterujące, więc OpenClaw nie utworzy dla niej możliwego do skopiowania polecenia powłoki. Sprawdź przygotowane odwołanie bezpośrednio i wprowadź ścieżkę ręcznie z zachowaniem ostrożności.",
      dismiss: "Odrzuć powiadomienie o konflikcie obszaru roboczego",
      eventSender: "Obszar roboczy w chmurze",
      eventTitleOne: "Wynik z chmury zastosowany z 1 konfliktem",
      eventTitleMany: "Wynik z chmury zastosowany z {count} konfliktami",
      eventDescription:
    ...
    questions: {
      ...
      ownAnswerFor: "Twoja własna odpowiedź na {header}",
      submitting: "Przesyłanie…",
      submitFailed: "Nie można przesłać: {error}",
      answered: "Odpowiedziano",
      answeredElsewhere: "Odpowiedziano w innym miejscu",
      unavailable: "Niedostępne",
      expired: "Wygasł",
      cancelled: "Anulowano",
    },
    ...
    modelControls: {
      ...
      resetToDefault: "Przywróć domyślny ({model})",
    },
    sideChat: {
      title: "Czat boczny",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w edytorze wiadomości, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
      dictationAudioUnsupported: "Gateway zwrócił nieobsługiwany format dźwięku dyktowania.",
      dictationBrowserAudioUnsupported:
        "Ta przeglądarka nie może przechwytywać dźwięku dyktowania z częstotliwością 8 kHz.",
      dictationConnecting: "Rozpoczynanie dyktowania…",
      dictationDisconnected: "Dyktowanie zatrzymane, ponieważ Gateway został rozłączony.",
      dictationFailed: "Dyktowanie nie powiodło się.",
      dictationFinalizing: "Kończenie dyktowania…",
      dictationFinalizationTimedOut:
        "Dyktowanie zatrzymano, zanim można było sfinalizować ostatni fragment transkrypcji.",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub Domyślną systemu.",
    ...
    toolCards: {
      ...
      pinToDashboard: "Przypnij do pulpitu",
