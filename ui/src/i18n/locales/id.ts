...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Sesi mungkin sudah tidak ada, atau direktori auth-nya perlu dibersihkan secara manual.",
    },
  ...
  agentChip: {
    menuLabel: "Menu agen",
    agents: "Agen",
    openChat: "Mengobrol dengan {name}",
  ...
  sessionsView: {
    ...
    viewArchived: "Lihat arsip",
    sessionArchived: "Utas diarsipkan",
    sessionsArchived: "Mengarsipkan {count} utas",
    ...
    cloudWorkerPlacementConflict: "Cloud worker: {state} · 1 konflik ruang kerja",
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} konflik ruang kerja",
    cloudWorkerDescendantConflict: "Anak cloud worker: 1 konflik ruang kerja",
    cloudWorkerDescendantConflicts: "Anak cloud worker: {count} konflik ruang kerja",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Bilah Samping",
      hint: "Pilih apa yang muncul saat sesi berjalan.",
  ...
  subtitles: {
    ...
    advanced: "Setiap bagian konfigurasi yang tersisa, ditambah editor file mentah.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw memulai sesi baru; pesan sebelumnya tetap tersimpan sebagai konteks.",
    unsupportedGateway: "Perbarui Gateway untuk melanjutkan penyiapan dengan OpenClaw.",
    history: {
      button: "Riwayat",
      title: "Perubahan terbaru",
      description: "Apa yang berubah pada sistem ini, terbaru lebih dulu.",
      ...
      changedPaths: "Jalur yang berubah ({count})",
      invalidEdit: "Pengeditan manual ini tidak lolos validasi konfigurasi.",
      opaqueChange: "Format atau komentar berubah tanpa perubahan jalur konfigurasi yang terlihat.",
      sources: {
    ...
    nudge: {
      configReload: "Pemuatan ulang konfigurasi terhenti — tanyakan kepada saya apa yang terjadi",
      channelAuth: "Autentikasi {channel} menurun — tanyakan kepada saya apa yang terjadi",
      channelDisconnected: "{channel} baru saja terputus — tanyakan kepada saya apa yang terjadi",
      channelDegraded: "{channel} menurun — tanyakan kepada saya apa yang terjadi",
      channelFallback: "Sebuah kanal",
  ...
  mcpServers: {
    ...
    addedSuccess: "Menambahkan server MCP {name}.",
    enabledSuccess: "Mengaktifkan server MCP {name}.",
    disabledSuccess: "Menonaktifkan server MCP {name}.",
    removedSuccess: "Menghapus server MCP {name}.",
  ...
  mcpPage: {
    connectorsLink: "Temukan konektor satu klik di halaman Plugins.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Terfilter",
  ...
  labsPage: {
    intro:
      "Labs berisi kemampuan eksperimental yang dapat berubah, rusak, atau hilang antar rilis.",
    sectionTitle: "Fitur eksperimental",
    sectionDescription: "Perubahan disimpan segera dan berlaku untuk proses agen mendatang.",
    documentation: "Dokumentasi",
    restartRequired: "Diperlukan restart Gateway.",
    ...
    swarm: {
      title: "Swarm",
      description: "Biarkan Code Mode mengatur grup subagen secara paralel.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikasi pendamping untuk ponsel, jam tangan, desktop, dan browser Anda — plus plugin untuk memperluas kemampuan agen Anda.",
    ...
    badgeBundledAndroid: "Termasuk dengan aplikasi Android",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Ponsel Android Anda sebagai node OpenClaw penuh — obrolan, kamera, dan Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Obrolan sekilas dan balasan cepat dari pergelangan tangan Anda.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Pendamping bilah menu untuk Gateway Anda — notifikasi, persetujuan, obrolan cepat.",
      },
      windows: {
        title: "Windows",
        desc: "Pendamping Windows menghubungkan PC Anda sebagai node OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Aplikasi desktop asli — build .deb dan AppImage.",
      },
      chrome: {
        title: "Ekstensi Chrome",
        desc: "Biarkan OpenClaw menjalankan Chrome Anda yang sudah ada — tab, halaman, dan formulir.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        invalid: "Gambar itu tidak dapat diproses.",
  ...
  gatewayLogs: {
    title: "Log",
    subtitle: "Log file Gateway (JSONL).",
    ...
    autoFollow: "Ikuti otomatis",
    file: "File: {file}",
    truncated: "Keluaran log dipangkas; menampilkan potongan terbaru.",
  ...
  board: {
    ...
    actionInProgress: "Perubahan dasbor lainnya masih sedang disimpan.",
    announcement: {
      moved: "Memindahkan {title}.",
      resized: "{title} diubah ukurannya.",
    ...
    widget: {
      ...
      rejectedDetail: "Widget ini tetap tidak aktif sampai dihapus atau diganti.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Pergantian cabang tidak tersedia saat agen sedang bekerja.",
      branchSwitchRequiresAdmin: "Pergantian cabang memerlukan akses admin operator.",
    ...
    board: {
      faceLabel: "Face thread",
      chatFace: "Chat",
      dashboardFace: "Dashboard",
      dockMenu: "Dock chat: {dock}",
      dockLeft: "Dock chat ke kiri",
      dockRight: "Dock chat ke kanan",
      dockBottom: "Dock chat ke bawah",
      ...
      defaultTab: "Utama",
      mockPlaceholder: "Tampilan papan · {tabs} tab · {widgets} widget",
      mockOverview: "Ikhtisar",
      mockResearch: "Riset",
      mockSessionStatus: "Status thread",
      mockRecentFindings: "Temuan terbaru",
      mockSourceMap: "Peta sumber",
      resetTitle: "Reset percakapan?",
      resetDescription: "Konteks percakapan direset. Dasbor Anda tetap ada.",
    },
    catalog: {
    ...
    workspaceConflict: {
      titleOne: "1 konflik workspace cloud",
      titleMany: "{count} konflik workspace cloud",
      description:
        "OpenClaw mempertahankan versi lokal Anda dan menerapkan perubahan cloud lainnya. Periksa hasil yang di-stage atau ambil versinya untuk path yang berkonflik.",
      morePaths: "+{count} path lainnya",
      ...
      commandHelp:
        "Jalankan perintah ini di Bash atau zsh (Git Bash di Windows). Jika inspect menyatakan path tidak ada, cloud menghapusnya; verifikasi dan hapus path lokal secara manual. Jika checkout melaporkan konflik file/direktori, pindahkan atau hapus path lokal yang menghalangi, lalu coba lagi. Jika ref yang di-stage hilang, pemberitahuan sudah usang; jangan ubah path lokal.",
      commandsUnavailable:
        "Nama file ini mengandung karakter kontrol terminal, sehingga OpenClaw tidak akan membuat perintah shell yang dapat disalin untuknya. Periksa ref yang di-stage secara langsung dan masukkan path secara manual dengan hati-hati.",
      dismiss: "Tutup pemberitahuan konflik ruang kerja",
      eventSender: "Ruang kerja cloud",
      eventTitleOne: "Hasil cloud diterapkan dengan 1 konflik",
      eventTitleMany: "Hasil cloud diterapkan dengan {count} konflik",
      eventDescription:
        "Versi lokal dipertahankan untuk jalur ini; perubahan cloud lainnya diterapkan.",
    },
    compaction: {
    ...
    messages: {
      ...
      hide: "Sembunyikan",
      hideConfirm: "Sembunyikan pesan ini di browser ini? Agen tetap melihatnya.",
    ...
    composer: {
      ...
      microphoneAppliesNextSession: "Perubahan diterapkan saat Anda memulai sesi Talk berikutnya.",
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon composer, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
