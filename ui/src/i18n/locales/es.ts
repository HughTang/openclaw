...
export const es: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      getApps: "Obtener las aplicaciones",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Los workers en la nube requieren el runtime de OpenClaw; está seleccionado {runtime}.",
  ...
  sessionsView: {
    ...
    attentionRequired: "La sesión necesita atención",
    model: "Modelo",
    provider: "Proveedor",
    ...
    cloudWorkerDescendantConflict: "Worker hijo en la nube: 1 conflicto de espacio de trabajo",
    cloudWorkerDescendantConflicts:
      "Workers hijos en la nube: {count} conflictos de espacio de trabajo",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG o WebP. Las imágenes se recortan al centro y se redimensionan a 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Las notificaciones las muestra de forma nativa la app OpenClaw en este Mac.",
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Elige qué se muestra mientras hay sesiones en ejecución.",
      liveActivity: "Mostrar actividad del agente en vivo en la barra lateral",
      liveActivityHint:
        "Muestra la última actividad del asistente o de las herramientas debajo de las sesiones en ejecución.",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    connectionChanged:
      "La conexión del Gateway cambió. Reintenta para continuar esta configuración.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Lo que cambió en este sistema, del más reciente al más antiguo.",
      ...
      changedPaths: "Rutas cambiadas ({count})",
      invalidEdit: "Esta edición manual no pasó la validación de configuración.",
      opaqueChange:
        "El formato o los comentarios cambiaron sin cambios visibles en las rutas de configuración.",
      sources: {
    ...
    nudge: {
      configReload: "La recarga de configuración se detuvo — pregúntame qué pasó",
      channelAuth: "La autenticación de {channel} se degradó — pregúntame qué pasó",
      channelDisconnected: "{channel} se acaba de desconectar — pregúntame qué pasó",
  ...
  mcpServers: {
    ...
    adminRequired: "Los cambios en el servidor MCP requieren acceso operator.admin.",
    enable: "Activar",
    disable: "Desactivar",
  ...
  mcpPage: {
    connectorsLink: "Descubre conectores de un solo clic en la página de Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Los cambios se guardan de inmediato y se aplican a futuras ejecuciones del agente.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatea, habla, aprueba acciones y comparte con OpenClaw desde iOS.",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "El complemento para Android extiende OpenClaw a tu reloj.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "El complemento para Windows conecta tu PC como un nodo de OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      ...
      setIdentity: "Configurar identidad",
      avatar: "Avatar",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleTitle: "Esta app anclada está obsoleta",
      ...
      frameAuthorizationFailed:
        "Falló la autorización del widget tras varios intentos de actualización.",
      sandboxOriginRequired:
        "Falló la autorización del widget tras varios intentos de actualización. Si el gateway se ejecuta detrás de un proxy inverso o túnel que no enruta el puerto del sandbox del widget, establece mcp.apps.sandboxOrigin en un origen público dedicado enrutado al listener del sandbox.",
      errorTitle: "No se pudo cargar este widget",
      errorDetail: "El problema se limita a esta tarjeta.",
      actionErrorTitle: "Falló el cambio del widget",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Acoplar chat a la izquierda",
      dockRight: "Acoplar chat a la derecha",
      dockBottom: "Acoplar chat abajo",
      ...
      mockPlaceholder: "Vista de tablero · {tabs} pestañas · {widgets} widgets",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw conservó tus versiones locales y aplicó los demás cambios de la nube. Inspecciona el resultado preparado o toma su versión para una ruta en conflicto.",
      morePaths: "+{count} rutas más",
      stagedResult: "Resultado preparado de la nube",
      copyStagedResult: "Copiar ref del resultado preparado",
      inspectCloud: "Inspeccionar la primera versión de la nube",
      takeCloud: "Tomar la primera versión de la nube",
      copyInspectCommand: "Copiar comando de inspección de la nube",
      copyTakeCommand: "Copiar comando take-cloud",
      commandHelp:
        "Ejecuta estos en Bash o zsh (Git Bash en Windows). Si inspect indica que la ruta no existe, la nube la eliminó; verifícalo y elimina la ruta local manualmente. Si checkout informa un conflicto de archivo/directorio, mueve o elimina la ruta local que bloquea, luego reintenta. Si falta la ref preparada, el aviso está desactualizado; no cambies la ruta local.",
      commandsUnavailable:
        "Este nombre de archivo contiene caracteres de control de terminal, por lo que OpenClaw no creará un comando de shell copiable para él. Inspecciona la ref preparada directamente e introduce la ruta manualmente con cuidado.",
      dismiss: "Descartar aviso de conflicto de workspace",
      eventSender: "Workspace en la nube",
      eventTitleOne: "Resultado de la nube aplicado con 1 conflicto",
      eventTitleMany: "Resultado de la nube aplicado con {count} conflictos",
      eventDescription:
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente aún lo verá.",
      ...
      rewind: "Retroceder",
      rewindConfirm: "¿Retroceder a antes de este mensaje?",
      rewindToHere: "Retroceder hasta aquí",
      rewindUnavailable: "Rebobinar no está disponible mientras el agente está trabajando",
      forkUnavailable: "Bifurcar no está disponible mientras el agente está trabajando",
    ...
    composer: {
      ...
      cameraInput: "Cámara",
      cameraListUnsupported: "Este navegador no puede listar las cámaras.",
      ...
      microphoneAppliesNextSession:
        "Los cambios se aplican cuando inicias tu próxima sesión de Talk.",
      ...
      holdToRecordSetting: "Mantén pulsado el botón del micrófono para dictar",
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del compositor, habla y luego suéltalo para insertar el texto sin enviarlo.",
      ...
      selectedCameraUnavailable:
        "La cámara seleccionada no está disponible. Elige otra cámara o el valor predeterminado del sistema.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Este widget debe volver a renderizarse para exportarse como imagen.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Se requiere acceso de escritura del operador para abrir este debate.",
      opened: "Debate de la sesión",
      openExternal: "Abrir debate en una pestaña nueva",
