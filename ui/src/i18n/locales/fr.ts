...
export const fr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Aucune session WhatsApp enregistrée n'a été effacée. Elle est peut-être déjà absente, ou son répertoire d'authentification nécessite un nettoyage manuel.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Hors ligne — ouvrir les Paramètres",
  ...
  sessionsView: {
    ...
    deleteAllArchived: "Supprimer toutes les archives…",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Votre profil gateway",
      ...
      profileHint:
        "JPEG, PNG ou WebP. Les images sont recadrées au centre et redimensionnées à 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "Les notifications sont affichées nativement par l'application OpenClaw sur ce Mac.",
    ...
    sidebarPrefs: {
      ...
      hint: "Choisissez ce qui apparaît pendant l'exécution des sessions.",
  ...
  subtitles: {
    ...
    labs: "Capacités expérimentales d'agent et d'outils.",
    ...
    advanced: "Toutes les sections de configuration restantes, plus l'éditeur de fichier brut.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw a démarré une nouvelle session ; les messages précédents restent disponibles pour le contexte.",
    ...
    history: {
      ...
      sources: {
        ...
        settings: "paramètres",
        cli: "CLI",
        pluginInstall: "installation du plugin",
  ...
  mcpServers: {
    ...
    adminRequired: "Les modifications des serveurs MCP nécessitent un accès operator.admin.",
    enable: "Activer",
    disable: "Désactiver",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections des threads",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales susceptibles de changer, de cesser de fonctionner ou de disparaître d'une version à l'autre.",
    sectionTitle: "Fonctionnalités expérimentales",
    sectionDescription:
      "Les modifications sont enregistrées immédiatement et s'appliquent aux prochaines exécutions de l'agent.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Applications compagnons pour votre téléphone, votre montre, votre ordinateur et votre navigateur — plus des plugins pour étendre les capacités de votre agent.",
    ...
    sectionDesktop: "Sur votre bureau",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Votre téléphone Android comme un nœud OpenClaw complet — chat, caméra et Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Aperçus des conversations et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Le compagnon Android étend OpenClaw à votre montre.",
      },
      macos: {
        title: "macOS",
        desc: "Compagnon de barre de menus pour votre Gateway — notifications, approbations, chat rapide.",
      },
      windows: {
        title: "Windows",
        desc: "Le compagnon Windows connecte votre PC en tant que nœud OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "Étendez OpenClaw avec des canaux, des outils et des Skills de la communauté.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Votre profil d'identité n'a pas pu être chargé.",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie de journal tronquée ; affichage du dernier segment.",
  ...
  board: {
    ...
    emptyTitle: "Un tableau vide, prêt pour le travail",
    emptyHint:
    ...
    widget: {
      ...
      activeCapabilities: "Fonctionnalités actives du widget",
      ...
      sandboxOriginRequired:
        "L'autorisation du widget a échoué après plusieurs tentatives d'actualisation. Si le gateway s'exécute derrière un proxy inverse ou un tunnel qui ne route pas le port du bac à sable du widget, définissez mcp.apps.sandboxOrigin sur une origine publique dédiée routée vers l'écouteur du bac à sable.",
  ...
  workboard: {
    ...
    dashboardEmpty:
      "Aucun tableau de bord pour l'instant — l'agent actif peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Jonction de la vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
      mockResearch: "Recherche",
      mockSessionStatus: "Statut du fil",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw a conservé vos versions locales et appliqué les autres modifications cloud. Inspectez le résultat préparé ou reprenez sa version pour un chemin en conflit.",
      morePaths: "+{count} chemins supplémentaires",
      stagedResult: "Résultat cloud préparé",
      copyStagedResult: "Copier la référence du résultat préparé",
      ...
      commandHelp:
        "Exécutez-les dans Bash ou zsh (Git Bash sous Windows). Si inspect indique que le chemin n'existe pas, le cloud l'a supprimé ; vérifiez et supprimez le chemin local manuellement. Si checkout signale un conflit fichier/répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la référence préparée est absente, l'avis est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
        "Ce nom de fichier contient des caractères de contrôle de terminal, donc OpenClaw ne créera pas de commande shell copiable pour celui-ci. Inspectez directement la référence préparée et saisissez le chemin manuellement avec précaution.",
      dismiss: "Ignorer l'avis de conflit de l'espace de travail",
    ...
    messages: {
      ...
      hideTooltip: "Masquer uniquement dans ce navigateur",
      openInCanvas: "Ouvrir dans le canevas",
      reply: "Répondre",
      replyToMessage: "Répondre au message",
      rewind: "Revenir en arrière",
      rewindConfirm: "Revenir à l'état avant ce message ?",
      rewindToHere: "Revenir à cet endroit",
      rewindUnavailable: "Le retour arrière est indisponible pendant que l'agent travaille",
    ...
    modelControls: {
      ...
      usingDefault: "Utilisation de la valeur par défaut des Réglages",
    ...
    composer: {
      ...
      cameraInput: "Caméra",
      cameraListUnsupported: "Ce navigateur ne peut pas lister les caméras.",
      ...
      microphoneAppliesNextSession:
        "Les modifications s'appliqueront au démarrage de votre prochaine session Talk.",
      ...
      dictationFinalizationTimedOut:
        "La dictée s'est arrêtée avant que la dernière transcription partielle ne puisse être finalisée.",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée n'est pas disponible. Choisissez une autre caméra ou celle par défaut du système.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Ce widget doit être régénéré pour être exporté en tant qu'image.",
    ...
    sessionDiscussion: {
      ...
      opened: "Discussion de session",
      openExternal: "Ouvrir la discussion dans un nouvel onglet",
      frameTitle: "Discussion de session",
