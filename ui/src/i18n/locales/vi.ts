...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp đã lưu nào được xóa. Có thể phiên đó đã không còn, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Trình xử lý đám mây yêu cầu runtime OpenClaw; {runtime} đang được chọn.",
  ...
  sessionsView: {
    ...
    sessionArchived: "Luồng đã lưu trữ",
    sessionsArchived: "Đã lưu trữ {count} luồng",
    deleteAllArchived: "Xóa tất cả đã lưu trữ…",
    deleteAllArchivedConfirm: "Xóa {count} chuỗi hội thoại đã lưu trữ và bản ghi của chúng?",
    ...
    dashboardAvailable: "Đã có bảng điều khiển",
    approvalNeeded: "Cần phê duyệt",
    ...
    cloudWorkerPlacementConflict: "Cloud worker: {state} · 1 xung đột workspace",
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} xung đột workspace",
    cloudWorkerDescendantConflict: "Cloud worker con: 1 xung đột workspace",
    cloudWorkerDescendantConflicts: "Cloud worker con: {count} xung đột workspace",
    ...
    invalidEmojiIcon: "Nhập đúng một emoji.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được hiển thị gốc bởi ứng dụng OpenClaw trên máy Mac này.",
      ...
      nativeBlockedHint:
        "Thông báo bị tắt cho OpenClaw trong macOS. Cho phép chúng trong Cài đặt hệ thống > Thông báo.",
    },
    appearance: {
      theme: "Giao diện",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Hiển thị hoạt động agent trực tiếp trong thanh bên",
      liveActivityHint:
        "Hiển thị hoạt động trợ lý hoặc công cụ mới nhất bên dưới các phiên đang chạy.",
    },
    connection: {
      title: "Kết nối",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Yêu cầu đang chờ khác",
  ...
  subtitles: {
    ...
    custodian: "Thiết lập và chăm sóc hệ thống.",
    ...
    labs: "Khả năng tác nhân và công cụ thử nghiệm.",
    ...
    advanced: "Tất cả các phần cấu hình còn lại, cùng trình chỉnh sửa tệp thô.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Thiết lập và chăm sóc hệ thống.",
    exitSetup: "Thoát thiết lập",
    newAgent: "Tác nhân mới",
    hatchDraft: "Dậy đi nào, bạn của tôi!",
    ...
    connectionChanged: "Kết nối Gateway đã thay đổi. Thử lại để tiếp tục thiết lập này.",
    sessionRestarted:
      "{error} OpenClaw đã bắt đầu một phiên mới; các tin nhắn trước đó vẫn được giữ để làm ngữ cảnh.",
    ...
    history: {
      ...
      invalidEdit: "Chỉnh sửa thủ công này không vượt qua kiểm tra hợp lệ cấu hình.",
      opaqueChange:
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ dùng chữ cái, số, dấu chấm, dấu gạch ngang hoặc dấu gạch dưới.",
    targetInvalid: "Nhập URL cho truyền tải HTTP hoặc dòng lệnh hợp lệ cho stdio.",
    nameTaken: "Đã tồn tại một máy chủ MCP tên “{name}”.",
    ...
    connectRequired: "Kết nối với gateway để thay đổi máy chủ MCP.",
    adminRequired: "Thay đổi máy chủ MCP yêu cầu quyền truy cập operator.admin.",
    enable: "Bật",
    disable: "Tắt",
  ...
  sessionsPage: {
    hubTablistLabel: "Các phần luồng",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs chứa các tính năng thử nghiệm có thể thay đổi, hỏng hoặc biến mất giữa các bản phát hành.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript nhỏ gọn, được cách ly.",
    },
    swarm: {
      title: "Swarm",
      description: "Cho phép Code Mode điều phối các nhóm subagent song song.",
  ...
  appsPage: {
    heroTitle: "Mang OpenClaw đi khắp mọi nơi",
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin để mở rộng khả năng của agent.",
    ...
    ctaDocs: "Tài liệu",
    ctaSetupGuide: "Hướng dẫn cài đặt",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Trò chuyện, gọi, phê duyệt hành động và chia sẻ vào OpenClaw từ iOS.",
      },
      android: {
        title: "Android",
        desc: "Điện thoại Android của bạn như một nút OpenClaw đầy đủ — trò chuyện, camera và Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh tin nhắn và trả lời tức thì ngay trên cổ tay.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Ứng dụng đồng hành Windows kết nối PC của bạn như một nút OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Ứng dụng máy tính gốc — bản dựng .deb và AppImage.",
      },
      chrome: {
        title: "Tiện ích mở rộng Chrome",
        desc: "Cho phép OpenClaw điều khiển Chrome hiện có của bạn — tab, trang và biểu mẫu.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Hình ảnh được thay đổi kích thước thành 256 × 256 hoặc nhỏ hơn.",
      chooseAvatar: "Chọn hình ảnh",
      processingAvatar: "Đang xử lý…",
      displayName: "Tên hiển thị",
      displayNameDescription: "Hiển thị cho những người khác đang sử dụng gateway này.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Hãy chọn hình ảnh có kích thước 10 MB hoặc nhỏ hơn.",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Tự động theo dõi",
    file: "Tệp: {file}",
    truncated: "Đầu ra nhật ký bị cắt bớt; đang hiển thị phần mới nhất.",
  ...
  board: {
    ...
    tabsLabel: "Thẻ bảng điều khiển",
    moreTabs: "Thêm thẻ bảng điều khiển",
    gridLabel: "Tiện ích bảng điều khiển",
    emptyTitle: "Bảng trống, sẵn sàng làm việc",
    emptyHint:
    ...
    announcement: {
      ...
      granted: "Đã cho phép truy cập tiện ích.",
      rejected: "Truy cập widget bị từ chối.",
    },
    widget: {
      cellLabel:
        "Widget bảng điều khiển: {title}. Dùng phím mũi tên để di chuyển. Giữ Alt và nhấn phím mũi tên để di chuyển nó.",
      ...
      needsApprovalDetail: "Widget này yêu cầu quyền truy cập bổ sung.",
      networkAccess: "Nguồn gốc mạng",
      hostTools: "Công cụ và dữ liệu máy chủ",
      activeCapabilities: "Các khả năng widget đang hoạt động",
      networkCapability: "Mạng: {capability}",
      toolCapability: "Công cụ: {capability}",
      granted: "Đã cấp",
      allow: "Cho phép",
      reject: "Từ chối",
      rejected: "Truy cập bị từ chối",
      rejectedDetail: "Widget này vẫn không hoạt động cho đến khi bị gỡ bỏ hoặc thay thế.",
      appLoading: "Đang khôi phục ứng dụng…",
      appStaleTitle: "Ứng dụng được ghim này đã lỗi thời",
      ...
      sandboxUnavailable: "Máy chủ sandbox widget không khả dụng.",
      frameAuthorizationFailed: "Ủy quyền widget thất bại sau nhiều lần thử làm mới.",
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu gateway chạy sau reverse proxy hoặc tunnel không định tuyến cổng sandbox widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai chuyên dụng được định tuyến đến trình lắng nghe sandbox.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Đã sao chép",
      branches: "Nhánh chủ đề",
      branchSwitchUnavailable: "Không thể chuyển nhánh khi agent đang làm việc.",
      branchSwitchRequiresAdmin: "Chuyển nhánh yêu cầu quyền quản trị viên vận hành.",
    ...
    board: {
      ...
      dockMenu: "Khung trò chuyện: {dock}",
    ...
    workspaceConflict: {
      titleOne: "1 xung đột không gian làm việc trên đám mây",
      titleMany: "{count} xung đột không gian làm việc trên đám mây",
      description:
        "OpenClaw đã giữ các phiên bản cục bộ của bạn và áp dụng các thay đổi khác trên đám mây. Kiểm tra kết quả đã sắp xếp hoặc lấy phiên bản của nó cho một đường dẫn xung đột.",
      morePaths: "+{count} đường dẫn nữa",
      stagedResult: "Kết quả đám mây đã sắp xếp",
      copyStagedResult: "Sao chép ref kết quả đã sắp xếp",
      ...
      copyTakeCommand: "Sao chép lệnh take-cloud",
      commandHelp:
        "Chạy những lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu inspect báo rằng đường dẫn không tồn tại, đám mây đã xóa nó; hãy xác minh và xóa đường dẫn cục bộ thủ công. Nếu checkout báo cáo xung đột tệp/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang chặn, rồi thử lại. Nếu ref đã sắp xếp bị thiếu, thông báo đã lỗi thời; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tệp này chứa các ký tự điều khiển terminal, vì vậy OpenClaw sẽ không tạo lệnh shell có thể sao chép cho nó. Hãy kiểm tra ref đã sắp xếp trực tiếp và nhập đường dẫn thủ công một cách cẩn thận.",
      dismiss: "Bỏ qua thông báo xung đột không gian làm việc",
      eventSender: "Không gian làm việc trên đám mây",
      eventTitleOne: "Kết quả đám mây được áp dụng với 1 xung đột",
      eventTitleMany: "Kết quả đám mây được áp dụng với {count} xung đột",
      eventDescription:
        "Các phiên bản cục bộ được giữ lại cho những đường dẫn này; các thay đổi đám mây khác đã được áp dụng.",
    },
    compaction: {
    ...
    questions: {
      ...
      ownAnswer: "Câu trả lời của bạn…",
      ownAnswerFor: "Câu trả lời của bạn cho {header}",
      submitting: "Đang gửi…",
    ...
    messages: {
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Tác nhân vẫn thấy được.",
      ...
      forkUnavailable: "Không thể tách nhánh khi tác nhân đang làm việc",
      showLess: "Thu gọn",
      showMore: "Xem thêm",
    ...
    composer: {
      ...
      noCameras: "Không tìm thấy máy ảnh bổ sung",
      ...
      dictationFinalizationTimedOut:
        "Đã dừng đọc chính tả trước khi bản ghi một phần cuối cùng được hoàn tất.",
      dictationProviderUnavailable: "Chưa cấu hình nhà cung cấp phiên âm nào cho đọc chính tả.",
      ...
      selectedCameraUnavailable:
        "Máy ảnh đã chọn không khả dụng. Hãy chọn máy ảnh khác hoặc Mặc định hệ thống.",
      ...
      switchCamera: "Chuyển máy ảnh",
      turnCameraOff: "Tắt máy ảnh",
      turnCameraOn: "Bật máy ảnh",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Widget này cần được kết xuất lại để xuất dưới dạng hình ảnh.",
