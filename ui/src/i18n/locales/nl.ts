...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Afgemeld.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de authenticatiemap vereist mogelijk handmatige opschoning.",
    },
  ...
  agentChip: {
    ...
    switchAgent: "Van agent wisselen",
    working: "Bezig…",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud-workers vereisen de OpenClaw-runtime; {runtime} is geselecteerd.",
  ...
  sessionsView: {
    ...
    viewArchived: "Gearchiveerde bekijken",
    ...
    cloudWorkerDescendantConflict: "Cloud worker-onderliggend: 1 workspaceconflict",
    cloudWorkerDescendantConflicts: "Cloud worker-onderliggenden: {count} workspaceconflicten",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Je gateway-profiel",
      assistantIdentity: "Assistent-identiteit",
      displayName: "Weergavenaam",
      displayNamePlaceholder: "Je naam",
      saveProfile: "Naam opslaan",
      saving: "Opslaan…",
      uploading: "Bezig met verwerken…",
      profileHint:
        "JPEG, PNG of WebP. Afbeeldingen worden vanuit het midden bijgesneden en verkleind tot 512px.",
      profileLoadFailed: "Kan je profiel niet laden.",
      profileSaveFailed: "Kan je profiel niet opslaan.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Live agentactiviteit in zijbalk tonen",
      liveActivityHint: "Toon de nieuwste assistent- of toolactiviteit onder actieve sessies.",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    reviewRequest: "Goedkeuring beoordelen van {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Begeleidende apps voor telefoon, horloge, desktop en browser.",
  ...
  custodian: {
    ...
    exitSetup: "Configuratie afsluiten",
    ...
    connectionChanged:
      "De Gateway-verbinding is gewijzigd. Probeer opnieuw om deze installatie voort te zetten.",
    sessionRestarted:
      "{error} OpenClaw is een nieuwe sessie gestart; eerdere berichten blijven behouden als context.",
    unsupportedGateway: "Werk de Gateway bij om de installatie met OpenClaw voort te zetten.",
    history: {
      button: "Geschiedenis",
      ...
      invalidEdit: "Deze handmatige bewerking heeft de configuratievalidatie niet doorstaan.",
      opaqueChange:
      ...
      sources: {
        ...
        settings: "instellingen",
        cli: "CLI",
        pluginInstall: "plug-in-installatie",
        manualEdit: "handmatige bewerking",
        unknown: "onbekend",
      },
    },
    nudge: {
      configReload: "Herladen van configuratie gestopt — vraag me wat er is gebeurd",
      channelAuth: "{channel}-authenticatie verslechterd — vraag me wat er is gebeurd",
      channelDisconnected: "{channel} is zojuist ontkoppeld — vraag me wat er is gebeurd",
  ...
  mcpServers: {
    ...
    adminRequired: "Wijzigingen aan de MCP-server vereisen operator.admin-toegang.",
    enable: "Inschakelen",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen veranderen, stuk kunnen gaan of kunnen verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en gelden voor toekomstige agent-runs.",
    documentation: "Documentatie",
    restartRequired: "Gateway-herstart vereist.",
    saveErrorTitle: "Kon functie niet bijwerken",
  ...
  appsPage: {
    ...
    heroTagline:
      "Companion-apps voor je telefoon, horloge, desktop en browser — plus plugins om uit te breiden wat je agent kan doen.",
    sectionMobile: "Op je telefoon",
    havePhone: "Heb je de app al?",
    pairDevice: "Koppel je apparaat",
    sectionWatch: "Op je pols",
    ...
    cards: {
      ...
      chrome: {
        ...
        desc: "Laat OpenClaw je bestaande Chrome besturen — tabbladen, pagina's en formulieren.",
      },
      plugins: {
        title: "Plug-ins & ClawHub",
  ...
  profilePage: {
    ...
    identity: {
      ...
      processingAvatar: "Bezig met verwerken…",
      displayName: "Weergavenaam",
      displayNameDescription: "Zichtbaar voor andere mensen die deze gateway gebruiken.",
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer afgekapt; nieuwste deel wordt getoond.",
  ...
  board: {
    ...
    emptyTitle: "Een leeg bord, klaar voor gebruik",
    ...
    widget: {
      cellLabel:
        "Dashboardwidget: {title}. Gebruik de pijltjestoetsen om te navigeren. Houd Alt ingedrukt en druk op een pijltjestoets om het te verplaatsen.",
      ...
      needsApprovalDetail: "Deze widget heeft aanvullende toegang aangevraagd.",
      ...
      sandboxUnavailable: "Sandboxhost voor widgets is niet beschikbaar.",
      frameAuthorizationFailed: "Widgetautorisatie is mislukt na herhaalde vernieuwingspogingen.",
      sandboxOriginRequired:
        "Widgetautorisatie is mislukt na herhaalde vernieuwingspogingen. Als de gateway achter een reverse proxy of tunnel draait die de sandboxpoort van de widget niet routeert, stel dan mcp.apps.sandboxOrigin in op een specifieke openbare oorsprong die naar de sandboxlistener wordt gerouteerd.",
      errorTitle: "Deze widget kon niet worden geladen",
      errorDetail: "Het probleem blijft beperkt tot deze kaart.",
      actionErrorTitle: "Widgetwijziging is mislukt",
      actionErrorDetail: "Het dashboard heeft de vorige widgetstatus behouden.",
  ...
  chat: {
    ...
    board: {
      ...
      reopenChat: "Chat tonen",
      workboardCard: "Workboard-kaart: {title}, {status}",
      defaultTab: "Hoofd",
      mockPlaceholder: "Bordweergave-verbinding · {tabs} tabbladen · {widgets} widgets",
      mockOverview: "Overzicht",
      mockResearch: "Onderzoek",
      mockSessionStatus: "Threadstatus",
      mockRecentFindings: "Recente bevindingen",
      mockSourceMap: "Broncaart",
      resetTitle: "Gesprek resetten?",
      resetDescription: "De gesprekscontext wordt gereset. Je dashboard blijft behouden.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw heeft je lokale versies behouden en de andere cloudwijzigingen toegepast. Bekijk het staged resultaat of neem de versie ervan over voor een conflicterend pad.",
      morePaths: "+{count} meer paden",
      stagedResult: "Staged cloudresultaat",
      copyStagedResult: "Staged result-ref kopiëren",
      ...
      commandHelp:
        "Voer deze uit in Bash of zsh (Git Bash op Windows). Als inspect zegt dat het pad niet bestaat, heeft de cloud het verwijderd; controleer dit en verwijder het lokale pad handmatig. Als checkout een bestands-/mapconflict meldt, verplaats of verwijder het blokkerende lokale pad en probeer het opnieuw. Als de staged ref ontbreekt, is de melding verouderd; wijzig het lokale pad niet.",
      commandsUnavailable:
        "Deze bestandsnaam bevat terminal-besturingstekens, dus OpenClaw bouwt er geen kopieerbaar shell-commando voor. Inspecteer de staged ref rechtstreeks en voer het pad zorgvuldig handmatig in.",
    ...
    questions: {
      ...
      collapse: "Vraag inklappen",
      expand: "Vraag uitklappen",
      eyebrow: "Vraag",
    ...
    messages: {
      activity: "Activiteit",
      forkFromHere: "Hiervandaan aftakken",
      hide: "Verbergen",
      hideConfirm: "Dit bericht in deze browser verbergen? De agent ziet het nog steeds.",
      ...
      rewind: "Terugspoelen",
      rewindConfirm: "Terugspoelen naar vóór dit bericht?",
      rewindToHere: "Naar hier terugspoelen",
      rewindUnavailable: "Terugspoelen is niet beschikbaar terwijl de agent bezig is",
      forkUnavailable: "Vertakken is niet beschikbaar terwijl de agent bezig is",
    ...
    modelControls: {
      ...
      usingDefault: "Standaard uit Instellingen gebruiken",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop van de composer ingedrukt, spreek en laat vervolgens los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported:
        "De Gateway retourneerde een niet-ondersteund audioformaat voor dictaat.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dictaataudio op 8 kHz vastleggen.",
      dictationConnecting: "Dictaat starten…",
      dictationDisconnected: "Dictaat gestopt omdat de Gateway is losgekoppeld.",
      dictationFailed: "Dictaat mislukt.",
      dictationFinalizing: "Dictaat afronden…",
      dictationFinalizationTimedOut:
        "Dictaat is gestopt voordat het laatste gedeeltelijke transcript kon worden afgerond.",
      dictationProviderUnavailable: "Er is geen transcriptieprovider geconfigureerd voor dictaat.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget exporteren mislukt. Probeer het opnieuw.",
