...
export const ja_JP: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "ログアウトしました。",
      logoutNotCleared:
        "保存された WhatsApp セッションはクリアされませんでした。すでに存在しないか、認証ディレクトリを手動でクリーンアップする必要がある場合があります。",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "クラウドワーカーには OpenClaw ランタイムが必要です。{runtime} が選択されています。",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count}件のアーカイブ済みスレッドとその文字起こしを削除しますか？",
    ...
    cloudWorkerPlacementConflict: "クラウドワーカー: {state} · ワークスペースの競合 1件",
    cloudWorkerPlacementConflicts: "クラウドワーカー: {state} · ワークスペースの競合 {count}件",
    cloudWorkerDescendantConflict: "クラウドワーカーの子: ワークスペースの競合 1件",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "あなたのGatewayプロファイル",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "通知はこの Mac 上の OpenClaw アプリによってネイティブに表示されます。",
      ...
      nativeBlockedHint:
        "macOS で OpenClaw の通知が無効になっています。システム設定 > 通知で許可してください。",
    },
    appearance: {
      theme: "テーマ",
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} からの承認を確認: {command}",
  ...
  subtitles: {
    ...
    apps: "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリ。",
    ...
    notifications: "Gatewayからのブラウザプッシュ通知。",
    security: "Gateway認証、実行ポリシー、ツールプロファイル、承認。",
  ...
  custodian: {
    ...
    newAgent: "新しいエージェント",
    hatchDraft: "起きて、相棒！",
    placeholder: "OpenClawにメッセージを送信…",
    sensitivePlaceholder: "機密性のある値を入力…",
    sensitiveReply: "機密性のある返信を送信しました",
    send: "送信",
    thinking: "OpenClaw が考えています",
    earlier: "以前",
    requestFailed: "OpenClaw が返信できませんでした。もう一度お試しください。",
    connectionChanged:
      "Gateway 接続が変更されました。このセットアップを続行するには再試行してください。",
    sessionRestarted:
      "{error} OpenClaw は新しいセッションを開始しました。以前のメッセージは文脈として残ります。",
    unsupportedGateway: "OpenClaw でセットアップを続行するには Gateway を更新してください。",
    history: {
      button: "履歴",
      title: "最近の変更",
      description: "このシステムで変更された内容を新しい順に表示します。",
      loading: "最近の変更を読み込み中…",
      empty: "まだ記録された変更はありません。",
      requestFailed: "OpenClaw が変更履歴を読み込めませんでした。",
      loadMore: "さらに読み込む",
      loadingMore: "さらに読み込み中…",
      changedPaths: "変更されたパス ({count})",
      invalidEdit: "この手動編集は構成の検証に合格しませんでした。",
      opaqueChange: "表示可能な構成パスの変更なしに、書式やコメントが変更されました。",
      sources: {
    ...
    nudge: {
      configReload: "設定の再読み込みが停止しました — 何が起きたか聞いてください",
      channelAuth: "{channel} の認証が低下しています — 何が起きたか聞いてください",
  ...
  mcpServers: {
    ...
    nameInvalid: "サーバー名には英字、数字、ドット、ダッシュ、アンダースコアを使用します。",
    targetInvalid:
      "HTTP トランスポートには URL を、stdio には有効なコマンドラインを入力してください。",
    nameTaken: "「{name}」という名前の MCP サーバーは既に存在します。",
    missing: "MCPサーバー「{name}」が構成内に見つかりませんでした。",
    missingTransport: "トランスポートがありません",
    addedSuccess: "MCPサーバー {name} を追加しました。",
    enabledSuccess: "MCPサーバー {name} を有効にしました。",
    disabledSuccess: "MCPサーバー {name} を無効にしました。",
    removedSuccess: "MCPサーバー {name} を削除しました。",
    configUnavailable: "構成を利用できません。更新して再試行してください。",
    connectRequired: "MCPサーバーを変更するにはGatewayに接続してください。",
    adminRequired: "MCPサーバーの変更には operator.admin アクセスが必要です。",
    enable: "有効化：",
    disable: "無効化",
  ...
  mcpPage: {
    connectorsLink: "Pluginsページでワンクリックコネクタを見つけましょう。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  labsPage: {
    intro: "Labsには、リリース間で変更・破損・削除される可能性がある実験的機能が含まれます。",
    sectionTitle: "実験的機能",
    sectionDescription: "変更は即座に保存され、今後のエージェント実行に適用されます。",
    documentation: "ドキュメント",
    restartRequired: "Gatewayの再起動が必要です。",
    ...
    swarm: {
      title: "Swarm",
      description:
        "Code Mode に、複数のサブエージェントのグループを並列でオーケストレーションさせます。",
      empty: "アクティブな Swarm はありません。",
      defaultPhase: "フェーズなし",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    heroTitle: "OpenClaw をどこへでも",
    heroTagline:
      "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリ — さらにエージェントの機能を拡張するプラグインも。",
    ...
    badgeBundledIos: "iOS アプリに含まれています",
    badgeBundledAndroid: "Android アプリに含まれています",
    ...
    ctaBrowseClawHub: "ClawHub を閲覧",
    linkDiscord: "Discord コミュニティ",
    linkDocs: "ドキュメント",
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS からチャット、通話、アクションの承認、OpenClaw への共有ができます。",
      },
      android: {
        title: "Android",
        desc: "Android スマートフォンを完全な OpenClaw ノードに — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手元でひと目でわかるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android コンパニオンが OpenClaw を腕時計に拡張します。",
      },
      macos: {
        title: "macOS",
        desc: "Gateway のメニューバーコンパニオン — 通知、承認、クイックチャット。",
      },
      windows: {
        title: "Windows",
        desc: "Windows コンパニオンで PC を OpenClaw ノードとして接続します。",
      },
      linux: {
        title: "Linux",
        desc: "ネイティブデスクトップアプリ — .deb と AppImage ビルド。",
      },
      chrome: {
        title: "Chrome 拡張機能",
      ...
      plugins: {
        title: "プラグイン & ClawHub",
        desc: "コミュニティのチャンネル、ツール、スキルで OpenClaw を拡張します。",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "この Gateway でのあなたのプロフィールです。",
      loading: "アイデンティティを読み込んでいます…",
      profileUnavailable: "アイデンティティプロフィールを読み込めませんでした。",
      notSet: "アイデンティティが設定されていません。",
      setIdentity: "アイデンティティを設定",
      avatar: "アバター",
      avatarDescription: "PNG、JPEG、または WebP。画像は 256 × 256 以下にリサイズされます。",
      chooseAvatar: "画像を選択",
      processingAvatar: "処理中…",
      displayName: "表示名",
      displayNameDescription: "この Gateway を使用する他のユーザーに表示されます。",
      linkedEmails: "リンクされたメール",
      linkedEmailsDescription: "このプロフィールに接続されたメールアドレス。",
      openSettings: "{name} のアイデンティティ設定を開く",
      avatarErrors: {
        invalid: "その画像を処理できませんでした。",
        sourceTooLarge: "10 MB 以下の画像を選択してください。",
        tooLarge: "処理されたアバターが 512 KB を超えています。",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyTitle: "作業準備が整った空のボード",
    emptyHint:
      "エージェントはここにウィジェットをピン留めできます — ステータスカードを頼んでみましょう。",
    ...
    widget: {
      cellLabel:
        "ダッシュボードウィジェット: {title}。矢印キーで移動します。Alt を押しながら矢印キーを押すと移動できます。",
      moveHandle: "{title} を移動",
      resizeHandle: "{title} をリサイズ",
      ...
      activeCapabilities: "アクティブなウィジェット機能",
      ...
      rejectedDetail: "このウィジェットは、削除または置き換えられるまで非アクティブのままです。",
      appLoading: "アプリを復元しています…",
      appStaleTitle: "このピン留めされたアプリは古くなっています",
      appStaleDetail:
        "そのサーバー、リソース、または元となるトランスクリプトは利用できなくなりました。",
      retry: "再試行",
      frameResolverMissing: "ウィジェットのコンテンツを利用できません。",
      sandboxUnavailable: "ウィジェットのサンドボックスホストを利用できません。",
      frameAuthorizationFailed: "更新を繰り返し試みましたが、ウィジェットの認証に失敗しました。",
      sandboxOriginRequired:
        "更新を繰り返し試みましたが、ウィジェットの認証に失敗しました。ゲートウェイがウィジェットサンドボックスのポートをルーティングしないリバースプロキシまたはトンネルの背後で動作している場合は、mcp.apps.sandboxOrigin にサンドボックスリスナーへルーティングされる専用のパブリックオリジンを設定してください。",
      errorTitle: "このウィジェットを読み込めませんでした",
      errorDetail: "問題はこのカード内に限定されています。",
      actionErrorTitle: "ウィジェットの変更に失敗しました",
      actionErrorDetail: "ダッシュボードは以前のウィジェットの状態を維持しました。",
      errorShow: "詳細を表示",
      kindMcp: "MCP",
      kindHtml: "HTML",
    },
  ...
  workboard: {
    ...
    dashboardEmpty:
      "まだダッシュボードはありません — 作業中のエージェントがウィジェットをピン留めできます。",
    openSession: "セッションを開く",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "コピーしました",
      branches: "スレッドのブランチ",
      branchSwitchUnavailable: "エージェントの作業中はブランチの切り替えを利用できません。",
    ...
    board: {
      ...
      resetDescription:
        "会話のコンテキストがリセットされます。ダッシュボードはそのまま維持されます。",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw はローカルバージョンを保持し、他のクラウドの変更を適用しました。ステージングされた結果を確認するか、競合しているパスについてクラウドのバージョンを採用してください。",
      morePaths: "他{count}件のパス",
      stagedResult: "ステージングされたクラウド結果",
      copyStagedResult: "ステージング結果の参照をコピー",
      ...
      commandHelp:
        "これらは Bash または zsh（Windows では Git Bash）で実行してください。inspect がパスが存在しないと表示する場合は、クラウドがそれを削除しています。確認のうえ、ローカルパスを手動で削除してください。checkout がファイル/ディレクトリの競合を報告する場合は、妨げているローカルパスを移動または削除してから再試行してください。ステージング参照が見つからない場合は通知が古くなっています。ローカルパスは変更しないでください。",
      commandsUnavailable:
        "このファイル名にはターミナル制御文字が含まれているため、OpenClaw はコピー可能なシェルコマンドを生成しません。ステージング参照を直接確認し、パスは慎重に手動で入力してください。",
      dismiss: "ワークスペース競合通知を閉じる",
      eventSender: "クラウドワークスペース",
      eventTitleOne: "クラウド結果を適用しました（1件の競合あり）",
      eventTitleMany: "クラウド結果を適用しました（{count}件の競合あり）",
      eventDescription:
        "これらのパスではローカルバージョンが保持され、その他のクラウド変更が適用されました。",
    },
    compaction: {
      label: "圧縮された履歴",
    ...
    questions: {
      ...
      timeRemaining: "残り時間",
      ownAnswer: "独自の回答…",
      ownAnswerFor: "{header} に対する独自の回答",
      submitting: "送信中…",
      submitFailed: "送信できませんでした: {error}",
      answered: "応答あり",
      answeredElsewhere: "別の場所で回答済み",
      unavailable: "利用不可",
      expired: "期限切れ",
      cancelled: "キャンセル済み",
    },
    messages: {
      ...
      rewindUnavailable: "エージェントの動作中は巻き戻しを利用できません",
      forkUnavailable: "エージェントの動作中はフォークを利用できません",
      showLess: "折りたたむ",
      showMore: "もっと見る",
      unknownDate: "不明な日付",
      voiceNote: "ボイスメモ",
    ...
    composer: {
      ...
      cameraInput: "カメラ",
      cameraListUnsupported: "このブラウザはカメラの一覧表示に対応していません。",
      cameraNoneFound: "カメラが見つかりませんでした。",
      cameraPageInactive: "このページが非アクティブの間はカメラを利用できません。",
      ...
      microphoneAppliesNextSession: "変更は次回のTalkセッション開始時に適用されます。",
      ...
      holdToRecordSetting: "マイクボタンを長押しして音声入力",
      holdToRecordSettingDescription:
        "コンポーザーのマイクボタンを長押しして話し、離すとテキストが挿入され、送信はされません。",
      dictationAudioUnsupported: "Gatewayがサポートされていない音声入力の音声形式を返しました。",
      dictationBrowserAudioUnsupported: "このブラウザは8 kHzで音声入力の音声を取得できません。",
      dictationConnecting: "音声入力を開始しています…",
      dictationDisconnected: "Gatewayが切断されたため、音声入力を停止しました。",
      dictationFailed: "音声入力に失敗しました。",
      dictationFinalizing: "音声入力を終了しています…",
      dictationFinalizationTimedOut:
        "最後の部分的な文字起こしを確定する前に音声入力が停止しました。",
      dictationProviderUnavailable: "音声入力用の文字起こしプロバイダーが設定されていません。",
      dictationRecording: "録音中 {elapsed}",
      dictationReleaseToInsert: "離すと音声入力が挿入されます",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "このウィジェットを画像としてエクスポートするには、再レンダリングが必要です。",
